import numpy as np #untuk ambil fungsi trigonometri, fungsi array, radian, dll

sudut_satu = float(input("Masukkan sudut lengan pertama: ")) #minta data dr user
...
x = np.radians(sudut_satu) #ubah dalam bentuk radian, krn trigonometri di python pakai radian
y = np.radians(sudut_dua)
z = np.radians(sudut_tiga)

#sesuaikan dengan rumus matriks yang sudah ada
...
#simbol @ sama saja dengan np.matmul utk perkalian matriks
